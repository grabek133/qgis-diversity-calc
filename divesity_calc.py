...
from .divesity_calc_dialog import DiversityCalcDialog
import os.path
...
class DiversityCalc:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Divesity Calculator')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/divesity_calc/icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            # Filters setting for comboboxes
